# -*- encoding: utf-8 -*-
# stub: client_side_validations 15.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rails>.freeze, [">= 5.0.0.1", "< 6.1"])
      ...
      s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.69.0"])
      ...
      s.add_dependency(%q<rails>.freeze, [">= 5.0.0.1", "< 6.1"])
